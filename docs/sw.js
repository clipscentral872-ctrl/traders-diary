...
const VERSION = "c5e14634825c";
const SHELL = "diary-shell-" + VERSION;
const DATA = "diary-bars-" + VERSION;

const FILES = [
  "./", "./index.html", "./engine.js", "./replay.js", "./system.js", "./levels.js", "./lock.js", "./demo.js", "./revisit.js", "./dashboard.js", "./chart.js", "./watchlist.js", "./videos.js", "./diary.js",
